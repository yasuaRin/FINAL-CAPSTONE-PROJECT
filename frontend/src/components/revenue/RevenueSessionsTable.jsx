  ...
  return (
    <div className="lg:col-span-2 flex flex-col min-h-[500px] lg:h-[700px]">
      <style>{BASE_STYLE}</style>
        ...
        style={{ background: 'var(--card)', containerType: 'inline-size' }}
      >
        {/* Loading bar */}
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-full bg-blue-600/10 text-blue-600 text-xs border border-blue-600/20 whitespace-nowrap"
              >
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 text-white rounded-lg text-sm font-medium whitespace-nowrap min-h-[32px] hover:bg-blue-700 transition-colors"
              >
                <Plus size={12} />
          ...
          <div style={{ padding: "16px 20px", borderTop: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <select 
                ...
                style={{ padding: "6px 10px", borderRadius: 8, border: "1px solid var(--border)", background: "var(--bg)", color: "var(--foreground)", fontSize: 14, fontWeight: 500, cursor: "pointer", outline: "none" }}
              >
