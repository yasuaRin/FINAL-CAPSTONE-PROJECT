...
//   const activeCount = (localDateRange.preset !== 'allData' ? 1 : 0);
...
//         className="relative flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium transition-all text-white whitespace-nowrap"
//         style={{
//           backgroundColor: isHovered && !isOpen ? '#1d4ed8' : '#2563eb',
//         }}
//       >
//         <Filter size={13} />
//         {getDisplayText()}
//         {activeCount > 0 && (
//           <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-[#2563eb] text-white text-[9px] font-black flex items-center justify-center border-2 border-white">
//             {activeCount}
//           </span>
//         )}
...
//                           className="flex-1 bg-background border border-border rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-[#2563eb]/20 focus:border-[#2563eb]"
...
//                       className="w-full py-2 rounded-lg bg-[#2563eb]/10 text-[#2563eb] text-[9px] font-bold uppercase tracking-wider hover:bg-[#2563eb]/20 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
//                     >
//                       Apply Custom Range
//                     </button>
//                   </div>
