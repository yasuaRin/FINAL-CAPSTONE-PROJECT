      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          <div>
            ...
            <p className="text-black/40 text-[10px] font-bold uppercase tracking-widest leading-loose mb-6">
              WHERE COMMERCE MEETS HUMAN CONNECTION,<br/>
              Your digital partner to scales up your business
            </p>
          </div>
          <div>
          ...
          <div>
             ...
             <div className="mt-12 pt-8 border-t border-black/5">
                <h4 className="font-black mb-6 uppercase tracking-[0.4em] text-[10px] text-primary font-sans">Office</h4>
