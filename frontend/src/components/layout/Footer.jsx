             ...
             <ul className="space-y-6">
               <li>
                 <a href="https://wa.me/6285121057706" target="_blank" rel="noreferrer" className="flex items-start gap-6 group">
                   ...
                   <div><p className="text-[10px] text-black/20 font-black uppercase tracking-widest mb-1"> Phone / WhatsApp</p><p className="text-sm font-black text-black tracking-tight">+62 851 2105 7706</p></div>
                 </a>
               </li>
               <li>
